...
newsapi = NewsApiClient(api_key='7f1c026d63864f6a97e08264a922edbd')
...
df = get_sent_analysis('bitcoin', 'bbc-news, the verge, financial-times, reuters, metro, cointelegraph, crypto-coins-news, bloomberg, cnbc, business-insider, google-news, forbes, fortune', date(2023,2,1), date(2023,2,10))
